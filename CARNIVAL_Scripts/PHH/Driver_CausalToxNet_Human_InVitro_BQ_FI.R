...
# setwd(CurrentPath)
netFile <- "Resources/Liver_Specific_Signed_Omnipath_Network_CARNIVAL.tsv" # required
...
if (file.exists(paste0("Resources/inputs_CARNIVAL_DRT_",DRTconf,"_FULL_Cutoff1p5/",Compounds[counter_cp],"_",Doses[counter_do],"_",TimePoints[counter_tp],"a_logFC_measCont_Cutoff1p5.txt"))) {
  ...
  measFile <- paste0("Resources/inputs_CARNIVAL_DRT_",DRTconf,"_FULL_Cutoff1p5/",Compounds[counter_cp],"_",Doses[counter_do],"_",TimePoints[counter_tp],"a_logFC_measCont_Cutoff1p5.txt") # required
  weightFile <- paste0("Resources/inputs_CARNIVAL_PGN_FULL/",Compounds[counter_cp],"_",Doses[counter_do],"_",TimePoints[counter_tp],"a_logFC_scores.txt") # optional; if not, set to 'NULL'
  ...
  Result_dir <- paste0("CARNIVAL_Results_",Compounds[counter_cp],"_",TimePoints[counter_tp],"hr_",Doses[counter_do])
  ...
  NewMeasFileName <- paste0("Resources/DRT_",DRTconf,"_",Compounds[counter_cp],"_",TimePoints[counter_tp],"hr_",Doses[counter_do],"_Cutoff1p5.tsv")
