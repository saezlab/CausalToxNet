...
setwd("CausalToxNet/CARNIVAL_Scripts/RLR")
...
if (file.exists(paste0("Resources/inputs_CARNIVAL_DRT_",DRTconf,"_FULL_Cutoff1p5_Rat_Liver_repeated/",Compounds[counter_cp],"_",TimePoints[counter_tp],"day_",Doses[counter_do],"_measCont_Cutoff1p5_Rat_Liver_repeated.txt"))) {
    
  print("")
  print("===========================================")
  print(paste0("Optimising: ",Compounds[counter_cp]," [",counter_cp,"/",length(Compounds),"] - ",TimePoints[counter_tp],"Day [",counter_tp,"/",length(TimePoints),"] - ",Doses[counter_do]," [",counter_do,"/",length(Doses),"]"))
  print("===========================================")
  print("")
  
  # Specify the path to input files
  measFile <- paste0("Resources/inputs_CARNIVAL_DRT_",DRTconf,"_FULL_Cutoff1p5_Rat_Liver_repeated/",Compounds[counter_cp],"_",TimePoints[counter_tp],"day_",Doses[counter_do],"_measCont_Cutoff1p5_Rat_Liver_repeated.txt") # required
  weightFile <- paste0("Resources/inputs_CARNIVAL_PGN_FULL_Rat_Liver_repeated/",Compounds[counter_cp],"_",TimePoints[counter_tp],"day_",Doses[counter_do],"_scores_Rat_Liver_repeated.txt") # optional; if not, set to 'NULL'
  ...
  Result_dir <- paste0("CARNIVAL_Results_RatInVivo_repeated_",Compounds[counter_cp],"_",TimePoints[counter_tp],"hr_",Doses[counter_do])
  ...
  NewMeasFileName <- paste0("Resources/DRT_",DRTconf,"_",Compounds[counter_cp],"_",TimePoints[counter_tp],"Day_",Doses[counter_do],"_Cutoff1p5_Rat_PHH.tsv")
