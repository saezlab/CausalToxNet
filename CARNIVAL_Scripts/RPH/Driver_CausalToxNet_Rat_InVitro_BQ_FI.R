...
setwd("CausalToxNet/CARNIVAL_Scripts/RPH")
...
if (file.exists(paste0("Resources/inputs_CARNIVAL_DRT_",DRTconf,"_FULL_Cutoff1p5_Rat_PHH/",Compounds[counter_cp],"_",TimePoints[counter_tp],"hr_",Doses[counter_do],"_1_logFC_measCont_Cutoff1p5_Rat_PHH.txt"))) {
  ...
  measFile <- paste0("Resources/inputs_CARNIVAL_DRT_",DRTconf,"_FULL_Cutoff1p5_Rat_PHH/",Compounds[counter_cp],"_",TimePoints[counter_tp],"hr_",Doses[counter_do],"_1_logFC_measCont_Cutoff1p5_Rat_PHH.txt") # required
  weightFile <- paste0("Resources/inputs_CARNIVAL_PGN_FULL_Rat_PHH/",Compounds[counter_cp],"_",TimePoints[counter_tp],"hr_",Doses[counter_do],"_scores_Rat_PHH.txt") # optional; if not, set to 'NULL'
