...
runCARNIVAL_CTN <- function(CplexPath=NULL,
                        netFile=NULL,
                        measFile=NULL,
                        inputFile=NULL,
                        weightFile=NULL,
                        ...
                        repIndex3=repIndex3)
{
  ...
  #   repIndex2 <- as.numeric(argsJob[2])
  #   repIndex3 <- as.numeric(argsJob[3])
  # } else {
  ...
  if (file.exists(paste0("testFile_",repIndex1,"_",repIndex2,"_",repIndex3,".lp"))) {file.remove(paste0("testFile_",repIndex1,"_",repIndex2,"_",repIndex3,".lp"))} # might be useful for debugging
  if (file.exists(paste0("results_cplex_",repIndex1, "_",repIndex2,"_",repIndex3,".txt"))) {file.remove(paste0("results_cplex_",repIndex1,"_",repIndex2,"_",repIndex3,".txt"))}
  if (file.exists("cplex.log")) {file.remove("cplex.log")}
  if (file.exists(paste0("cplexCommand_", repIndex1,"_",repIndex2,"_",repIndex3,".txt"))) {file.remove(paste0("cplexCommand_", repIndex1,"_",repIndex2,"_",repIndex3,".txt"))}
  ...
  variables <- writeLPFile_CTN(data=measurements,pknList=pknList,inputs=inputs,betaWeight=betaWeight,
                           ...
                           repIndex1=repIndex1,repIndex2=repIndex2,repIndex3=repIndex3)
  ...
  if (Sys.info()[1]=="Windows") {
    ...
    system(paste0("cplex.exe -f cplexCommand_", repIndex1,"_",repIndex2,"_",repIndex3,".txt"))
    file.remove("cplex.exe")
    Elapsed_2 <- proc.time() - ptm
  } else {
    # system(paste0(CplexPath, " -f cplexCommand_", condition,"_",repIndex,".txt"))
    system(paste0(CplexPath, " -f cplexCommand_", repIndex1,"_",repIndex2,"_",repIndex3,".txt"))
    Elapsed_2 <- proc.time() - ptm
  }
  ...
  if (file.exists(paste0("testFile_", repIndex1,"_",repIndex2,"_",repIndex3,".lp"))) {file.remove(paste0("testFile_", repIndex1,"_",repIndex2,"_",repIndex3,".lp"))} # might be useful for debugging
  if (file.exists(paste0("results_cplex_", repIndex1,"_",repIndex2,"_",repIndex3,".txt"))) {file.copy(from = paste0("results_cplex_", repIndex1,"_",repIndex2,"_",repIndex3,".txt"),to = paste0(current_dir,"/",dir_name,"/results_cplex_", repIndex1,"_",repIndex2,"_",repIndex3,".txt")); file.remove(paste0("results_cplex_", repIndex1,"_",repIndex2,"_",repIndex3,".txt"))}
  if (file.exists("cplex.log")) {file.copy(from = "cplex.log",to = paste0(current_dir,"/",dir_name,"/cplex_", repIndex1,"_",repIndex2,"_",repIndex3,".log")); file.remove("cplex.log")}
  if (file.exists(paste0("cplexCommand_", repIndex1,"_",repIndex2,"_",repIndex3,".txt"))) {file.remove(paste0("cplexCommand_", repIndex1,"_",repIndex2,"_",repIndex3,".txt"))}
  ...
  if (file.exists(paste0(dir_name,"/results_cplex_", repIndex1,"_",repIndex2,"_",repIndex3,".txt"))) {
      for(i in 1:length(variables)){
      # res <- exportResult(cplexSolutionFileName = paste0(dir_name,"/results_cplex_",condition,"_",repIndex,".txt"),
      res <- exportResult(cplexSolutionFileName = paste0(dir_name,"/results_cplex_", repIndex1,"_",repIndex2,"_",repIndex3,".txt"),
  ...
  file.remove(paste0(dir_name,"/results_cplex_", repIndex1,"_",repIndex2,"_",repIndex3,".txt")) # optional; remove cplex results (to save space)
