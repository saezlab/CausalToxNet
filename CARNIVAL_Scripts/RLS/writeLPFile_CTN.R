...
writeLPFile_CTN <- function(data = data, pknList = pknList, inputs = inputs, alphaWeight=1, betaWeight=0.2, scores=scores, mipGAP=0.1, poolrelGAP=0.01, limitPop=100, poolCap=100, poolIntensity=0, poolReplace=2,timelimit=1800,measWeights=NULL, repIndex1=repIndex1,  repIndex2=repIndex2, repIndex3=repIndex3) {
  ...
  # write the .lp file
  data = paste0("testFile_", repIndex1,"_",repIndex2,"_",repIndex3,".lp")
  ...
  cplexCommand <- paste0("cplexCommand_", repIndex1,"_",repIndex2,"_",repIndex3,".txt")
  write(paste0("read testFile_", repIndex1,"_",repIndex2,"_",repIndex3,".lp"), cplexCommand, append = TRUE)
  ...
  write(paste0("write results_cplex_", repIndex1,"_",repIndex2,"_",repIndex3,".txt sol all"), cplexCommand, append = TRUE)
